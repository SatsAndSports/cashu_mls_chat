 ...
 */
export function clear_storage_cache() {
    const ret = wasm.clear_storage_cache();
    return ret;
}
 ...
 * @returns {string}
 */
export function get_nsec() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_nsec();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function get_pubkey_hex() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_pubkey_hex();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {Promise<any>}
 */
export function fetch_profile_metadata(npub) {
    const ptr0 = passStringToWasm0(npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_profile_metadata(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function publish_profile_metadata(metadata_json) {
    const ptr0 = passStringToWasm0(metadata_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.publish_profile_metadata(ptr0, len0);
    return ret;
}
 ...
 * @returns {string}
 */
export function get_trusted_mints() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_trusted_mints();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {boolean}
 */
export function remove_trusted_mint(mint_url) {
    const ptr0 = passStringToWasm0(mint_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.remove_trusted_mint(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {boolean}
 */
export function is_mint_trusted(mint_url) {
    const ptr0 = passStringToWasm0(mint_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.is_mint_trusted(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
 ...
 * @param {string} mint_url
 */
export function set_current_mint(mint_url) {
    const ptr0 = passStringToWasm0(mint_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.set_current_mint(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {string}
 */
export function get_current_mint() {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.get_current_mint();
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {Promise<any>}
 */
export function add_relay(url) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.add_relay(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function remove_relay(url) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.remove_relay(ptr0, len0);
    return ret;
}
...
export function get_transaction_history() {
    const ret = wasm.get_transaction_history();
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function get_all_mint_balances() {
    const ret = wasm.get_all_mint_balances();
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function send_ecash(amount) {
    _assertBigInt(amount);
    const ret = wasm.send_ecash(amount);
    return ret;
}
 ...
 * @param {bigint} amount
 * @param {string} recipient_npub
 * @returns {Promise<any>}
 */
export function send_ecash_p2pk(amount, recipient_npub) {
    _assertBigInt(amount);
    const ptr0 = passStringToWasm0(recipient_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.send_ecash_p2pk(amount, ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function decode_lightning_invoice(invoice) {
    const ptr0 = passStringToWasm0(invoice, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_lightning_invoice(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function pay_lightning_invoice_with_quote(quote_id) {
    const ptr0 = passStringToWasm0(quote_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.pay_lightning_invoice_with_quote(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function create_lightning_invoice(mint_url, amount, description) {
    const ptr0 = passStringToWasm0(mint_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    _assertBigInt(amount);
    const ptr1 = passStringToWasm0(description, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.create_lightning_invoice(ptr0, len0, amount, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function check_mint_quote(mint_url, quote_id) {
    const ptr0 = passStringToWasm0(mint_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(quote_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.check_mint_quote(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function create_and_publish_keypackage() {
    const ret = wasm.create_and_publish_keypackage();
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function delete_keypackage(event_id) {
    const ptr0 = passStringToWasm0(event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.delete_keypackage(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function debug_fetch_welcome_events() {
    const ret = wasm.debug_fetch_welcome_events();
    return ret;
}
 ...
 * @param {string} welcome_event_id
 * @param {string} kp_event_id
 * @returns {Promise<any>}
 */
export function process_welcome_event(welcome_event_id, kp_event_id) {
    const ptr0 = passStringToWasm0(welcome_event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(kp_event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.process_welcome_event(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function subscribe_to_welcome_messages(callback) {
    const ret = wasm.subscribe_to_welcome_messages(callback);
    return ret;
}
 ...
 * @param {string} name
 * @param {string} description
 * @param {string} keypackage_event_ids_json
 * @param {string} member_npubs_json
 * @param {string} is_admin_flags_json
 * @returns {Promise<any>}
 */
export function create_group_and_publish(name, description, keypackage_event_ids_json, member_npubs_json, is_admin_flags_json) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(description, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(keypackage_event_ids_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(member_npubs_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passStringToWasm0(is_admin_flags_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.create_group_and_publish(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function fetch_keypackages_for_npub(member_npub) {
    const ptr0 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_keypackages_for_npub(ptr0, len0);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function fetch_deletions_for_npub(member_npub) {
    const ptr0 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_deletions_for_npub(ptr0, len0);
    return ret;
}
 ...
 * @param {string} keypackage_event_id
 * @param {string} member_npub
 * @returns {Promise<any>}
 */
export function add_member_and_publish(group_id_hex, keypackage_event_id, member_npub) {
    const ptr0 = passStringToWasm0(group_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(keypackage_event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.add_member_and_publish(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}

/**
 * Step 2: Publish Welcome message to relays
 * @param {string} welcome_rumors_json
 * @param {string} member_npub
 * @returns {Promise<any>}
 */
export function publish_welcome_message(welcome_rumors_json, member_npub) {
    const ptr0 = passStringToWasm0(welcome_rumors_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.publish_welcome_message(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function promote_to_admin_and_publish(group_id_hex, member_npub) {
    const ptr0 = passStringToWasm0(group_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.promote_to_admin_and_publish(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function remove_member_from_group(group_id_hex, member_npub) {
    const ptr0 = passStringToWasm0(group_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(member_npub, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.remove_member_from_group(ptr0, len0, ptr1, len1);
    return ret;
}
...
function __wbg_adapter_21(arg0, arg1) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.wasm_bindgen__convert__closures_____invoke__h08fc284bc440e341(arg0, arg1);
}

function __wbg_adapter_24(arg0, arg1, arg2) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.closure3528_externref_shim(arg0, arg1, arg2);
}
...
function __wbg_adapter_253(arg0, arg1, arg2, arg3) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm.closure3554_externref_shim(arg0, arg1, arg2, arg3);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_14c16a87d65afc99 = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 3527, function: Function { arguments: [Externref], shim_idx: 3528, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 3527, __wbg_adapter_24);
        return ret;
    }, arguments) };
    ...
    imports.wbg.__wbindgen_cast_4b9b86267976c619 = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 3055, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 3056, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 3055, __wbg_adapter_15);
        return ret;
    }, arguments) };
    imports.wbg.__wbindgen_cast_863bc064d6a89926 = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 3303, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 3304, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 3303, __wbg_adapter_10);
        return ret;
    }, arguments) };
    imports.wbg.__wbindgen_cast_90fe1cb6b705b7cc = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 3328, function: Function { arguments: [], shim_idx: 3329, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 3328, __wbg_adapter_29);
        return ret;
    }, arguments) };
    imports.wbg.__wbindgen_cast_9fe3beabd25af300 = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 2070, function: Function { arguments: [], shim_idx: 2073, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 2070, __wbg_adapter_18);
        return ret;
    }, arguments) };
    ...
    imports.wbg.__wbindgen_cast_cde788f34bf1f9e9 = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 1849, function: Function { arguments: [], shim_idx: 1850, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 1849, __wbg_adapter_21);
        return ret;
    }, arguments) };
